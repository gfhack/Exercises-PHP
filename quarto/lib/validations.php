<?php
 class Validations {
   ...
   public static function uniqueField($value, $field, $table, &$msg) {
   ...
   public static function lessThen($value, $maxSize, &$msg) {
     if ($value > $maxSize) {
   ...
   public static function inclusionIn($value, $array, &$msg) {
     if (in_array($value, $array)) {
        return true;
     }
     $msg = 'Tipo não permitido';
     return false;
   }
